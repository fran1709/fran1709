                    ...
                    <div className="mt-3">
                        ...
                        {dataPersona?.linkedin && (
                            <a href={dataPersona.linkedin} target="_blank" rel="noopener noreferrer">
                                <FaLinkedin size={35} className='shadow-lg aiconer'/>
                            </a>
                        )}
                        {/* Icono de GitHub con enlace al perfil de GitHub */}
                        {dataPersona?.github && (
                            <a href={dataPersona.github} target="_blank" rel="noopener noreferrer">
                                <FaGithub size={35} className="text-dark ms-3 shadow-lg aiconer" /> {/* Aplica la clase text-dark para hacer que el icono de GitHub sea negro */}
                            </a>
                        )}
                    </div>
                </div>
